...
describe("toLatestReleaseUrl — canonical /releases/latest mapping", () => {
  it("converts a tag-specific release URL to /releases/latest", () => {
    expect(
      toLatestReleaseUrl("https://github.com/Bmebme/py-llm-wiki/releases/tag/v0.4.0"),
    ).toBe("https://github.com/Bmebme/py-llm-wiki/releases/latest")
  })

  it("normalizes a bare /releases listing URL to /releases/latest", () => {
    expect(
      toLatestReleaseUrl("https://github.com/Bmebme/py-llm-wiki/releases"),
    ).toBe("https://github.com/Bmebme/py-llm-wiki/releases/latest")
  })

  it("is idempotent on an already-/latest URL", () => {
    expect(
      toLatestReleaseUrl("https://github.com/Bmebme/py-llm-wiki/releases/latest"),
    ).toBe("https://github.com/Bmebme/py-llm-wiki/releases/latest")
  })
  ...
  it("falls through unchanged for non-release github URLs", () => {
    expect(toLatestReleaseUrl("https://github.com/Bmebme/py-llm-wiki/issues/42")).toBe(
      "https://github.com/Bmebme/py-llm-wiki/issues/42",
    )
    expect(toLatestReleaseUrl("https://github.com/Bmebme/py-llm-wiki")).toBe(
      "https://github.com/Bmebme/py-llm-wiki",
    )
  })
})
